...
g_szNfoMainLicense:		db	"XTIDE Universal BIOS and XTIDECFG Copyright 2009-2012 by Tomi Tilli. Released under GNU GPL v2, with ABSOLUTELY NO WARRANTY. Details...",NULL

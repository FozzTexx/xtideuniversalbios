...
%endif
	...
	at	ROMVARS.ideVars2+IDEVARS.wBasePort,			dw	0D800h
	at	ROMVARS.ideVars2+IDEVARS.wControlBlockPort,	dw	0
	at	ROMVARS.ideVars2+IDEVARS.bDevice,			db	DEVICE_8BIT_JRIDE_ISA
